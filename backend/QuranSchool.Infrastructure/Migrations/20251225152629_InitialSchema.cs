        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Allocations_Classes_ClassId",
                        column: x => x.ClassId,
                        principalTable: "Classes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Allocations_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Allocations_Users_TeacherId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Assignments_Allocations_AllocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttendanceSessions_Allocations_AllocationId",
                        column: x => x.AllocationId,
                        principalTable: "Allocations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Allocations_ClassId",
                table: "Allocations",
                column: "ClassId");

            migrationBuilder.CreateIndex(
                name: "IX_Allocations_SubjectId",
                table: "Allocations",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_Allocations_TeacherId_ClassId_SubjectId",
                table: "Allocations",
                columns: new[] { "TeacherId", "ClassId", "SubjectId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Assignments_AllocationId",
                table: "Assignments",
                column: "AllocationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceSessions_AllocationId_SessionDate",
                table: "AttendanceSessions",
                columns: new[] { "AllocationId", "SessionDate" },
                unique: true);
